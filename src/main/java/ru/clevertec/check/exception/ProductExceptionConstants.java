...
public class ProductExceptionConstants {
    public static final String MESSAGE_EXCEPTION = "Messaging Exception";
    public static final String IOEXCEPTION = "IOException";
    public static final String ADDRESS_EXCEPTION = "Address Exception";
